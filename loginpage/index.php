...
<body class="bg-green-600 font-roboto">
    ...
    <div class=" flex-inline items-center pb-72 pt-32 sm:pl-40 lg:pl-48">
        <div class="">
            <h4 class="text-right justify-right text-4xl text-white pr-16 tracking-tight">Sistema de Biblioteca Institucional</h4>
        </div>
