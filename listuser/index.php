                            ...
                            <?php 
                             ...
                             echo ('<tr class="bg-white border-b  ">'.
                                 '<th scope="row" class="py-4 px-6 font-medium text-gray-900 whitespace-nowrap flex ">'.
                                    '<span class="my-auto"> '.$user_data['nameUser'].'</span>'.
                                '</th>'.
                                '<td class="py-4 px-6">'.
                                    $user_data['catUser'].
                                '</td>'.
                                ...
                                '<td class="py-4 px-6">'.
                                    '<a href="#"
                                        class=" border rounded-lg px-3 py-2.5 hover:bg-green-600 hover:text-white duration-200 ease-in-out font-medium text-green-600 hover:underline  ">Editar</a>'.
                                '</td>'.
                            '</tr>"');
