                ...
                <nav>
                    <ul class=" flex gap-x-1  font-roboto">
                        <form class="flex items-center" method="GET" action="">
                            ...
                            <button type="submit"
                                class="p-1.5 ml-2 mt-0.5 text-sm font-medium text-white bg-gray-50 rounded-lg border border-slate-300   focus:ring-1 focus:outline-none focus:ring-sky-500 drop-shadow ease-in duration-150 hover:scale-110  ">
                        ...
                        <div class="flex">
                            ...
                            <button id="dropdownDefault" data-dropdown-toggle="dropdown"
                                class=" flex-inline text-white  font-medium rounded-lg text-sm  text-center  items-center ease-in duration-150  "
        ...
        <div class=" px-3 pt-5 md:max-w-screen-xl  mx-auto text-gray-500 divide-y ">
            <div class=" mx-auto  item-center flex">
                <div class="mx-auto flex pt-8 pb-2  text-right">
                    <img src="<?php echo $cover; ?>" alt="Livro Duna" 
                        class=" md:mr-10 mr-4 rounded-lg drop-shadow md:w-48 md:h-72 w-32 h-48 object-cover">
                    <div class="text-left md:max-w-lg max-w-sm  break-words	 md:text-2sm tex-xs pt-1 ">
                ...
                <form class=" mt-4 p-2 md:mx-72 ">
                    <div class="mb-4bg-gray-50 rounded-lg border  border-gray-200 drop-shadow shadow-md ">
                        <div class="py-2 px-4  bg-white rounded-t-lg ">
                            ...
                            <textarea id="comment" rows="4" class="px-0 w-full   text-sm text-gray-900 bg-white border-0 "
                                placeholder="Deixe seu comentario aqui!" required=""></textarea>
                        </div>
                        <div class="py-2 px-3 border-t ">
                            <button type="submit"
                                class="inline-flex items-center py-2.5 px-4 text-xs font-medium text-center text-white bg-green-500 rounded-lg focus:ring-2 focus:ring-green-200  ease-in duration-150 hover:bg-green-700 ">
                                Postar Comentario
                            </button>
