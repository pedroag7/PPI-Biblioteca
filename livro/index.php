...
<body>
    <div class="w-full min-h-screen bg-white ">
                ...
                <nav>
                    <ul class=" flex gap-x-1  font-roboto">
                        <form class="flex items-center" method="GET" action="">
                            ...
                            <button type="submit" class="p-1.5 ml-2 mt-0.5 text-sm font-medium text-white bg-gray-50 rounded-lg border border-slate-300 hover:bg-sky-500  focus:ring-1 focus:outline-none focus:ring-sky-500 drop-shadow ease-in duration-150 hover:scale-110  ">
        ...
        <div class="p-3  pt-10 max-w-screen-xl mx-auto text-gray-500">
            <div class=" m-auto m-0 flex">
                <div class="mx-auto flex pt-8 text-right">
                    <img src="../dunabook.jpg" alt="Livro Duna" width="216" height="216" class=" mr-16 rounded-lg drop-shadow">
                    <div class="text-left mx-auto ">
                        <h1 class=" text-4xl text-slate-800 uppercase">Duna</h1>

                        <p class="text-sm pt-1 ">Paul Atreides é um jovem brilhante,
                            dono de um destino além de sua compreensão. <br>
                            Ele deve viajar para o planeta mais perigoso
                            do universo para garantir o futuro de seu povo. </p>
                        <br>
                        
                        <p class="italic ">Disponibilidade: <b class="text-black">2 Unidades</b></p>
                        
                    </div>
                </div>
            </div>

                <div class=" mt-4 px-48 mx-auto">
                <form>
                    <div class="mb-4 w-full bg-gray-50 rounded-lg border border-gray-200 ">
                        ...
                        <div class="flex justify-between items-center py-2 px-3 border-t ">
                            <button type="submit" class="inline-flex items-center py-2.5 px-4 text-xs font-medium text-center text-white bg-green-500 rounded-lg focus:ring-4 focus:ring-green-200  ease-in duration-150 hover:bg-green-700 ">
                                Postar Comentario
                            </button>
