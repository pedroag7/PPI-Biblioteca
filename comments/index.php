...
$sql = "SELECT * FROM ((comment INNER JOIN obra ON comment.idObra = obra.idObra)INNER JOIN users ON comment.idUser = users.idUser) WHERE approved = '0';";
                        ...
                        <tbody>
                            ...
                            while ($user_data = mysqli_fetch_assoc($result)) {
                                echo ('<tr class="bg-white border-b  ">' .
                                    ...
                                    . $user_data['comment'] .
                                    '<td class="py-4 px-4">' .
                                    '<a href="../php/approve.php?id=' . $user_data['idComment'] . '"
                                    ...
                                    '</td>' . 
                                    '<td class="py-4 px-4">' .
                                    '<a href="../php/deletecomment.php?id=' . $user_data['idComment'] . '"
