    ...
    <body class="font-roboto">
        <div class="w-full min-h-screen bg-white ">
            ...
            <header class="w-full bg-green-600 p-3 drop-shadow-sm text-white ">
                <div class="max-w-screen-xl w-full x-auto flex justify-between gap-x-2 drop-shadow">
                    <h1 class=" w-7 ">
            ...
            <div class="p-3  pt-4 max-w-screen-xl mx-auto text-gray-500 ">
                ...
                <h1 class="text-2xl pb-2 text-center italic "> Cadastro de Acervo </h1>

                <form action="../php/collection.php" method="POST" class="pl-4 pb-4 text-black border-1 rounded-lg shadow-sm w-9/12 items-center m-auto pt-2.5 ">
                    <div class="grid justify-center gap-6 mb-6 md:grid-cols-2 w-9/12 m-auto">
                        <div>
                            ...
                            <input type="text" name="tipoacervo" id="tipoacervo" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:outline-none focus:ring-green-500 focus:border-green-500 block w-full p-2.5 drop-shadow " placeholder="Ex.: Livro, DVD, Revista, … " required="">
                        </div>

                        <div>
                            <label for="codAcervo" class="block mb-2 text-sm font-medium  ">Codigo do acervo</label>
                            <input type="text" name="codAcervo" id="codAcervo" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:outline-none focus:ring-green-500 focus:border-green-500 block w-full p-2.5 drop-shadow " placeholder="23232323" required="">
                        </div>

                        <div>
                            <label for="classCdu" class="block mb-2 text-sm font-medium text-gray-900 ">Classificaçao
                                CDU</label>
                            <textarea id="classCdu" name="classCdu" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-green-500 focus:border-green-500 drop-shadow " placeholder="Tecnologia, cor azul"></textarea>
                        </div>


                        <button type="submit" name="submit" class="text-white bg-green-500 text-lg justify-center hover:bg-green-800 focus:ring-2 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm w-full sm:w-auto px-16 py-8 text-center shadow-sm shadow-green-400/50 justify-center duration-200 ease-in-out ">Cadastrar</button>
