      ...
      <form action="../php/edituser.php" method="POST" class="border pl-4 pb-4 text-black border-1 rounded-lg shadow-sm w-9/12 items-center m-auto pt-2.5 ">
        <div class="grid justify-center gap-6 mb-6 md:grid-cols-2 w-9/12 m-auto">
          <div>
            ...
            <input type="text" id="nome" name="nome" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:outline-none focus:ring-green-500 focus:border-green-500 block w-full p-2.5 drop-shadow" value="<?php echo $nome; ?>" required="">
          </div>
          <div>
            <label for="sobrenome" class="block mb-2 text-sm font-medium  ">Sobrenome</label>
            <input type="text" id="sobrenome" name="sobrenome" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:outline-none focus:ring-green-500 focus:border-green-500 block w-full p-2.5 drop-shadow" value="<?php echo $sobrenome; ?>" required="">
          </div>
          <div>

            <label for="curso" class="block mb-2 text-sm font-medium text-gray-900 ">Curso</label>
            <select id="curso" required="" name="course" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:outline-none focus:ring-green-500 focus:border-green-500 block w-full p-2.5 drop-shadow ease-in duration-150 ">
        ...
        <div class="mb-6 w-9/12 m-auto">
          ...
          <input type="email" id="email" name="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:outline-none focus:ring-green-500 focus:border-green-500 block w-full p-2.5 drop-shadow " value="<?php echo $emaill; ?>" required="">
        </div>
