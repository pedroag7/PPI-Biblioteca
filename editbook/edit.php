...
if (!empty($_GET['id'])) {
  ...
  if ($result->num_rows > 0) {
      while ($user_data = mysqli_fetch_assoc($result)) {
          ...
          $autor = $user_data['author'];
          $catergoria = $user_data['category'];
          $dataPublicacao = $user_data['publicationDate'];
          $editora = $user_data['publishCompany'];
          $codigo = $user_data['codObra'];
          $tradutor = $user_data['translator'];
          $local = $user_data['publishLocation'];
          $isbncod = $user_data['seriesISBN'];
          $descricaof = $user_data['physicalDescription'];
          $disponibilidade = $user_data['disponibility'];
          $sinopsee = $user_data['synopses'];
        }
  } else{
...
<body>
    <div class="w-full min-h-screen bg-white ">
        ...
        <header class="w-full bg-green-600 p-3 drop-shadow-sm text-white ">
            <div class="max-w-screen-xl mx-auto flex justify-between drop-shadow gap-x-2">
                <h1 class=" w-7 ">
                ...
                <div class="grid justify-center gap-6 mb-6 md:grid-cols-2 w-9/12 m-auto">
                    ...
                    <div>
                        ...
                        <select id="categLivro" name="category"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:outline-none focus:ring-green-500 focus:border-green-500 block w-full p-2.5 drop-shadow ">
                            <option selected><?php echo $catergoria; ?></option>
                    ...
                    <div class="">
                        ...
                        <input type="text" id="tradutor" name="translator"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:outline-none focus:ring-green-500 focus:border-green-500 block w-full p-2.5 drop-shadow "
                            value="<?php echo $tradutor; ?>" required="">
                    </div>
                    <div class="">
                    ...
                    <div class="">
                        ...
                        <input type="text" id="nSerie" name="isbn"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:outline-none focus:ring-green-500 focus:border-green-500 block w-full p-2.5 drop-shadow"
                            value="<?php echo $isbncod; ?>" required="">
                    </div>
                    <div>
                    ...
                    <div class="">
                        ...
                        <input type="text" name="descphysic" id="descFisica"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:outline-none focus:ring-green-500 focus:border-green-500 block w-full p-2.5 drop-shadow"
                            value="<?php echo $descricaof; ?>" required="">
                    </div>
                    <div class="">
                        <label for="dispon"
                        ...
                        <input type="text" name="disponibility" id="dispon"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:outline-none focus:ring-green-500 focus:border-green-500 block w-full p-2.5 drop-shadow"
                            value="<?php echo $disponibilidade ?>" required="">
                    </div>
                    <div>
                        ...
                        <textarea id="sinopse" name="synopses" rows="4"
                            ...
                            value="" required=""> <?php echo htmlspecialchars($sinopsee); ?> </textarea>
                    </div>
